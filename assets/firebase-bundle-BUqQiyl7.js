 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $P={".sv":"timestamp"};function wb(){return $P}Dt.prototype.simpleListen=function(n,e){this.sendRequest("q",{p:n},e)};Dt.prototype.echo=function(n,e){this.sendRequest("echo",{d:n},e)};jP();export{cb as A,db as B,XP as C,sb as D,JP as E,Kt as G,YP as a,gb as b,Ib as c,KP as d,eb as e,ZP as f,mb as g,QP as h,TE as i,ab as j,ob as k,yb as l,Eb as m,vb as n,Tb as o,hb as p,pb as q,ib as r,wb as s,_b as t,nb as u,ub as v,tb as w,fb as x,rb as y,lb as z};
